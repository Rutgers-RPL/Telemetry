...
def main(window):
    ...
    while True:
            ...
            window.addstr(2, 0, 'Brightness %5d (WS)' % camera.brightness)
            window.addstr(3, 0, 'Contrast   %5d (ED)' % camera.contrast)
            window.addstr(4, 0, 'Saturation %5d (RF)' % camera.saturation)
